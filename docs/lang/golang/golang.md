...
- [Базовые](https://habr.com/ru/articles/654569/)
- [Вопросы про конкретность](https://habr.com/ru/articles/670974/)
...
- [Сколько места занимает тип int? От чего это зависит?](./question.md#7-----int----)
...
- [Можно ли у функции реализовать метод?](./question.md#28------)
- [Если буф-й канал закрыть после записи туда N значений, что будет с горутинами, которые читают из него?](./question.md#29---------n---------)
- [Что такое тип Rune? Для чего нужен?](./question.md#30----rune---)
- [Как правильно скопировать slice, чтобы изменения не затронули изначальный?](./question.md#31----slice-----)
- [Какое максимальное количество goroutine может быть запущено?](./question.md#32---goroutine---)
- [Когда defer может не отработать?](./question.md#33--defer---)
- [Почему append возвращает новый slice?](./question.md#34--append---slice)
